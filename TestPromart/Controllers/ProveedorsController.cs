...
namespace TestPromart.Controllers
{
    ...
    public class ProveedorsController : ControllerBase
    {
        ...
        public ProveedorsController(OrdenServicioContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Proveedor>> PostProveedor(Proveedor proveedor)
        {
            ...
            return CreatedAtAction("GetProveedor", new { id = proveedor.NId }, proveedor);
        }
        ...
        {
            return _context.Proveedores.Any(e => e.NId == id);
        }
    }
}
