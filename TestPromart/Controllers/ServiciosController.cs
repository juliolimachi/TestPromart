...
namespace TestPromart.Controllers
{
    ...
    public class ServiciosController : ControllerBase
    {
        ...
        public ServiciosController(OrdenServicioContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Servicio>> PostServicio(Servicio servicio)
        {
            ...
            return CreatedAtAction("GetServicio", new { id = servicio.NIdS }, servicio);
        }
        ...
        {
            return _context.Servicios.Any(e => e.NIdS == id);
        }
    }
}
